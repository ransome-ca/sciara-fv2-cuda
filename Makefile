...
run-cuda-tiled-halo: $(CUDA_TILED_HALO)
	./$(CUDA_TILED_HALO) $(THREADS) $(INPUT_CONFIG) $(OUTPUT_CONFIG) $(STEPS) $(REDUCE_INTERVL) $(THICKNESS_THRESHOLD) && md5sum $(OUTPUT) && echo "704a4a65d1890589e952b155d53b110d"

run-cuda-tiled-no-halo: $(CUDA_TILED_NO_HALO)
	./$(CUDA_TILED_NO_HALO) $(THREADS) $(INPUT_CONFIG) $(OUTPUT_CONFIG) $(STEPS) $(REDUCE_INTERVL) $(THICKNESS_THRESHOLD) && md5sum $(OUTPUT) && echo "704a4a65d1890589e952b155d53b110d"
