...
run-cuda-straightforward: $(CUDA_STRAIGHTFORWARD)
	OMP_NUM_THREADS=$(THREADS) $(PROF) ./$(CUDA_STRAIGHTFORWARD) $(INPUT_CONFIG) $(OUTPUT_CONFIG) $(STEPS) $(REDUCE_INTERVL) $(THICKNESS_THRESHOLD) && md5sum $(OUTPUT) && echo "0c071cd864046d3c6aaf30997290ad6c"
